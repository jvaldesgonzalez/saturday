...
import { LoginUserAppleDto } from '../../dtos/check-user-status.dto';
...
@Injectable()
export class LoginUserApple implements IUseCase<LoginUserAppleDto, Response> {
  constructor(
  ...
  async execute(request: LoginUserAppleDto): Promise<Response> {
