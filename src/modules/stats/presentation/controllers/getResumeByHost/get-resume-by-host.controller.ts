...
@Injectable()
export class GetStatsResumeByHost extends BaseController<GetResumeByHostRequest, GetResumeByHostResponse>{
	constructor(@Inject('IStatsRepository') private _statsRepo: IStatsRepository) {super();}

	protected async executeImpl(req: GetResumeByHostRequest): Promise<GetResumeByHostResponse> {
